function [conv, full] = cnn_spec_Cfar10_2(  )
...
conv{i}.numFilters = 64;         % Number of filters for conv layer
...
full{9}.outputSize = 1024;

full{10}.outputSize = numClasses;
